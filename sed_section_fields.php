...
function _sed_sf_handle_section_post( $event , $step )
	{
	echo n."<script src='".hu."?sed_resources=sed_sf_section_js' type='text/javascript'></script>".n;
	_sed_sf_css();
	}
...
function _sed_sf_inject_section_admin( $page )
	...
	if( $rows && $c > 0 )
		...
		$f = '<script src=\''.hu.'?sed_resources=sed_sf_section_js\' type=\'text/javascript\'></script>';
...
function _sed_sf_handle_article_post( $event , $step )
	{
	echo n."<script src='".hu."?sed_resources=sed_sf_write_js' type='text/javascript'></script>".n;
	}
